...
.playerCenter:active{transform:translate(-50%,-50%) scale(.91)}.playerCenter svg{width:21px;height:21px}.playerShell.playing .playerCenter{opacity:0;pointer-events:none}
...
.playerControls{position:absolute;z-index:7;left:0;right:0;bottom:0;padding:44px 14px 10px;background:linear-gradient(to top,rgba(0,0,0,.88),rgba(0,0,0,.34) 46%,transparent);transition:opacity .2s,transform .2s}
.playerShell.controlsHidden:not(.settingsOpen) .playerControls{opacity:0;transform:translateY(7px);pointer-events:none}
.controlRow{position:relative;top:5px;display:flex;align-items:center;gap:1px;margin:0}.controlButton{width:38px;height:38px;flex:0 0 auto;border-radius:11px;display:grid;place-items:center;background:transparent;color:#fff;transition:transform .16s,opacity .16s}.controlButton:hover{background:transparent}.controlButton:active{transform:scale(.93);background:transparent}.controlButton svg{width:21px;height:21px;overflow:visible}.playButton{width:38px;height:38px}.playButton svg{width:21px;height:21px}.iconMorph{transform-origin:center;animation:iconMorphIn .24s cubic-bezier(.16,1,.3,1)}
.skipButton{width:38px;height:38px}.skipGlyph{position:relative;width:21px;height:21px;display:grid;place-items:center}.skipGlyph svg{position:absolute;inset:0;width:21px;height:21px;transition:transform .22s cubic-bezier(.16,1,.3,1)}.skipValue{position:relative;z-index:1;margin-top:1px;font-size:8px;font-weight:800;line-height:1;letter-spacing:-.04em}.backSkip:active .skipGlyph svg{transform:rotate(-18deg)}.forwardSkip:active .skipGlyph svg{transform:rotate(18deg)}
.playerTime{margin-left:2px;color:#d5d5d5;font-size:11px;font-variant-numeric:tabular-nums;white-space:nowrap}.controlSpacer{flex:1}.seekWrap{position:relative;height:17px;display:flex;align-items:flex-end}.seekBase{position:absolute;left:2px;right:2px;bottom:5px;height:3px;border-radius:99px;background:rgba(255,255,255,.17);overflow:hidden}.bufferedBar,.playedBar{position:absolute;inset:0 auto 0 0;width:0;border-radius:99px}.bufferedBar{background:rgba(255,255,255,.22)}.playedBar{background:#fff}.seek{position:relative;width:100%;height:17px;margin:0;appearance:none;-webkit-appearance:none;background:transparent}.seek::-webkit-slider-runnable-track{height:3px;background:transparent}.seek::-webkit-slider-thumb{-webkit-appearance:none;width:12px;height:12px;margin-top:-4.5px;border-radius:50%;background:#fff;box-shadow:0 1px 7px rgba(0,0,0,.42);transition:transform .14s}.seek:active::-webkit-slider-thumb{transform:scale(1.18)}.seek::-moz-range-track{height:3px;background:transparent}.seek::-moz-range-thumb{width:12px;height:12px;border:0;border-radius:50%;background:#fff}
...
.playerShell:fullscreen{border:0;border-radius:0}.playerShell:fullscreen .playerControls{padding-bottom:max(10px,env(safe-area-inset-bottom))}.playerShell:fullscreen .playerSettings{top:max(10px,env(safe-area-inset-top));right:max(10px,env(safe-area-inset-right))}.playerShell:fullscreen .qualityMenu{top:calc(max(10px,env(safe-area-inset-top)) + 44px);right:max(10px,env(safe-area-inset-right))}
...
@media(max-width:29rem){.page{padding-left:13px;padding-right:13px}.inputShell{grid-template-columns:auto minmax(0,1fr);gap:8px}.go{grid-column:1/-1;width:100%}.formats{grid-template-columns:repeat(2,minmax(0,1fr))}.controlButton,.playButton,.skipButton{width:36px;height:36px}.playerTime{margin-left:2px;font-size:10px}.playerControls{padding-left:8px;padding-right:8px;padding-bottom:10px}.playerSettings{right:8px;top:8px}.qualityMenu{right:8px;top:52px}.watchMeta{padding-top:15px}}
@media(any-pointer:coarse){.modeButton,.go,.primary,.save,.format{min-height:48px}.controlButton,.playButton,.skipButton{width:42px;height:42px}.url{min-height:48px}.seekWrap,.seek{height:22px}.seekBase{bottom:7px}}
