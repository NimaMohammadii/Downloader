...
.seekWrap{position:relative;height:16px;display:flex;align-items:flex-end}.seekBase{position:absolute;left:2px;right:2px;bottom:1px;height:2px;border-radius:99px;background:rgba(255,255,255,.17);overflow:hidden;transition:height .18s ease,background .18s ease,transform .18s ease}.seekWrap:hover .seekBase,.seekWrap:focus-within .seekBase{height:4px;background:rgba(255,255,255,.23)}.seekWrap:active .seekBase{height:4px;transform:scaleY(1.08)}.bufferedBar,.playedBar{position:absolute;inset:0 auto 0 0;width:0;border-radius:99px}.bufferedBar{background:rgba(255,255,255,.22)}.playedBar{background:#fff;transition:width .1s linear}.seek{position:relative;width:100%;height:16px;margin:0;appearance:none;-webkit-appearance:none;background:transparent}.seek::-webkit-slider-runnable-track{height:2px;background:transparent}.seek::-webkit-slider-thumb{-webkit-appearance:none;width:0;height:0;border:0;border-radius:0;background:transparent;box-shadow:none;opacity:0}.seek::-moz-range-track{height:2px;background:transparent}.seek::-moz-range-thumb{width:0;height:0;border:0;border-radius:0;background:transparent;box-shadow:none;opacity:0}
.controlRow{display:flex;align-items:center;gap:0;margin-top:-4px}.controlButton{width:36px;height:36px;flex:0 0 auto;border-radius:11px;display:grid;place-items:center;background:transparent;color:#fff;transition:transform .16s,opacity .16s}.controlButton:hover{background:transparent}.controlButton:active{transform:scale(.93);background:transparent}.controlButton svg{width:18px;height:18px;overflow:visible}.playButton{width:36px;height:36px;margin:0}.playButton svg{width:18px;height:18px}.muteButton svg{transform:translateX(4px)}.fullscreenButton svg{transform:translateX(-4px)}.iconMorph{transform-origin:center;animation:iconMorphIn .24s cubic-bezier(.16,1,.3,1)}
.playerTime{margin-left:3px;color:#d5d5d5;font-size:11px;font-variant-numeric:tabular-nums;white-space:nowrap}.controlSpacer{flex:1}
...
@media(max-width:29rem){.page{padding-left:13px;padding-right:13px}.inputShell{grid-template-columns:auto minmax(0,1fr);gap:8px}.go{grid-column:1/-1;width:100%}.formats{grid-template-columns:repeat(2,minmax(0,1fr))}.controlButton,.playButton{width:34px;height:34px}.playerTime{margin-left:2px;font-size:10px}.playerControls{padding-left:8px;padding-right:8px;padding-bottom:6px}.playerSettings{right:8px;top:8px}.qualityMenu{right:8px;top:52px}.watchMeta{padding-top:15px}}
@media(any-pointer:coarse){.modeButton,.go,.primary,.save,.format{min-height:48px}.controlButton,.playButton{width:40px;height:40px}.url{min-height:48px}.seekWrap,.seek{height:18px}}
