      ...
      <div id="playerCard" class="playerCard">
        <div id="playerShell" class="playerShell">
          ...
          <button id="centerPlay" class="playerCenter" type="button" aria-label="Play">
            <svg id="centerPlayIcon" viewBox="0 0 24 24" fill="none"><path d="M9.2 7.15c0-.92 1.02-1.48 1.8-.98l6.4 4.08c.72.46.72 1.54 0 2l-6.4 4.08c-.78.5-1.8-.06-1.8-.98V7.15Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </button>
          <div class="playerControls">
            ...
            <div class="controlRow">
              <button id="playPause" class="controlButton" type="button" aria-label="Play or pause"><svg id="playIcon" viewBox="0 0 24 24" fill="none"><path d="M9.2 7.15c0-.92 1.02-1.48 1.8-.98l6.4 4.08c.72.46.72 1.54 0 2l-6.4 4.08c-.78.5-1.8-.06-1.8-.98V7.15Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
...
function iconPlay(){return '<path d="M9.2 7.15c0-.92 1.02-1.48 1.8-.98l6.4 4.08c.72.46.72 1.54 0 2l-6.4 4.08c-.78.5-1.8-.06-1.8-.98V7.15Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'}
function iconPause(){return '<g fill="none" stroke="currentColor" stroke-dasharray="30" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M7 6h2v12h-2Z"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.4s" values="30;0"/></path><path stroke-dashoffset="30" d="M15 6h2v12h-2Z"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.4s" dur="0.4s" to="0"/></path></g>'}
